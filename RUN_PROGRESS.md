...
| 8 | Exp1 Step 3 | `python -m esm2_mech.experiments.mechanism_delta_cv` | `variants.json`, `cache/sequences.json`, `pfam_families.json`, `embeddings_*.npy`, `alphamissense_scores_full.json` | `results/run1/family_split_baselines_seed{0..4}.json` | ⏳ pending | run on RunPod |
