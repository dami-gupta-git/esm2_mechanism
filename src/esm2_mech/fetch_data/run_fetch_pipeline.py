...
Usage:
    ...
    python -m esm2_mech.fetch_data.run_fetch_pipeline --from-step 5
    python -m esm2_mech.fetch_data.run_fetch_pipeline --from-step 5 --pathogenic-only
...
from esm2_mech.fetch_data.build_gene_list import main as main_gene_list
from esm2_mech.fetch_data.build_gene_universe import main as main_universe
from esm2_mech.fetch_data.fetch_variants import (
    main_gerasimavicius,
    main_clinvar,
    main_merge,
)
from esm2_mech.fetch_data.fetch_sequences import main as main_fetch_sequences
from esm2_mech.fetch_data.fetch_annotations import (
    main_pfam,
    main_uniprot,
    main_enzyme,
)
from esm2_mech.fetch_data.build_proteome_features import main as main_proteome
from esm2_mech.fetch_data.build_badonyi_features import main as main_badonyi
from esm2_mech.utils.paths import DATA_DIR, check_prerequisites
